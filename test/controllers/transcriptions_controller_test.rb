...
class TranscriptionsControllerTest < ActionController::TestCase
  ...
  test "should create transcription" do
    assert_difference('Transcription.count') do
      post :create, transcription: { description: @transcription.description, pictures: @transcription.pictures, transcription: @transcription.transcription, user_name: @transcription.user_name }
    end
  ...
  test "should update transcription" do
    patch :update, id: @transcription, transcription: { description: @transcription.description, pictures: @transcription.pictures, transcription: @transcription.transcription, user_name: @transcription.user_name }
    assert_redirected_to transcription_path(assigns(:transcription))
  end
